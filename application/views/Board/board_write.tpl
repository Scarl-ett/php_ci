...
<div class="container mb-5">
    ...
    <form class="needs-validation" novalidate action="/Board/write/writeInsert" method="post" id="writeForm">
        <table class="table bg-white border">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td colspan="3" class="border-bottom">
                        <input type="password" name="bo_pw" class="form-control" placeholder="비밀글의 경우 게시글 비밀번호를 입력해주세요." readonly>
